...
public class Random extends Recommender {

    public Random(SparseMatrix trainMatrix, SparseMatrix testMatrix, int fold){
    ...
    protected double predict(int u, int j) throws Exception{
        ...
        return (randomNum>0) ? randomNum : this.globalMean;
    }
}
